...
def editCategory(category_id):
    ...
    if editedCategory.user_id != login_session['user_id']:
        ...
        output += " to edit this category. Please create your own category"
        output += " in order to edit.');}</script><body onload='myFunction()'>"
        return output
    if request.method == 'POST':
...
def newCategoryItem(category_id):
    ...
    if login_session['user_id'] != category.user_id:
        output = "<script>function myFunction() {alert('Not authorized"
        output += " to add item this category. Please create your own category"
        output += " in order to add items.');}"
        output += "</script><body onload='myFunction()'>"
        return output
    if request.method == 'POST':
...
@app.route('/catalog/<int:category_id>/menu/<int:item_id>/edit', methods=[
    'GET', 'POST'])
def editCategoryItem(category_id, item_id):
    ...
    if login_session['user_id'] != category.user_id:
        output = "<script>function myFunction() {alert('Not authorized"
        output += " to edit item this category. Please create your own"
        output += " category in order to edit items.');}"
        output += "</script><body onload='myFunction()'>"
        return output
    if request.method == 'POST':
        if request.form['name']:
...
# Delete a menu item
@app.route('/catalog/<int:category_id>/menu/<int:item_id>/delete', methods=[
    'GET', 'POST'])
def deleteCategoryItem(category_id, item_id):
    ...
    if login_session['user_id'] != category.user_id:
        output = "<script>function myFunction() {alert('Not authorized"
        output += " to delete category items. Please create your own"
        output += " category in order to delete items.');}"
        output += "</script><body onload='myFunction()'>"
        return output
    if request.method == 'POST':
